...
| Feature | Status | Since | Notes |
|---|---|---|---|
| E2E 测试套件 | 🟢 | 2026-05-09 | Playwright + 独立 HOME 隔离 + fake-claude 回显 CLI;smoke/commands/share 三条 spec;pnpm test:e2e 先 build web 再 headless chromium;host 全局 setup/teardown |
